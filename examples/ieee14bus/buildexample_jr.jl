using PowerDynamics: SlackAlgebraic, FourthOrderEq, PQAlgebraic, PiModelLine, StaticLine, Transformer, PowerGrid, write_powergrid, Json, SwingEq
...
buses=OrderedDict(
    ...
    "bus1"=> SwingEq(H=H, P=2.32, D=D, Ω=Ω),
    ...
    "bus3"=> SwingEq(H=H, P=-0.942, D=D, Ω=Ω),
    ...
    "bus6"=> SwingEq(H=H, P=-0.122, D=D, Ω=Ω),
    ...
    "bus8"=> SwingEq(H=H, P=0.0, D=D, Ω=Ω),
...
write_powergrid(powergrid, joinpath(@__DIR__,"grid_jr.json"), Json)