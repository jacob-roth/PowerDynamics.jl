...
powergrid = read_powergrid(joinpath(@__DIR__, "118notapnoshunt.json"), Json)
operationpoint = find_operationpoint(powergrid, sol_method = :dynamic) # solve_powerflow=true, 

operatingdata_path = "/Users/jakeroth/git/PowerDynamics.jl/examples/118busnotapnoshunt/"
...
norm(err_from_root(imported_operationpoint)) # 1.0682947627257781e-6
norm(err_from_root(operationpoint)) # 9.794761129874436e-9
